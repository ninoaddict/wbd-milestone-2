...
function RouteComponent() {
  ...
  return (
    <main className='flex flex-col items-center justify-center px-5 min-h-screen bg-[#f4f2ee]'>
      <header className="linkedin-logo-header">
        <a href="/login" className="absolute top-8 left-14" aria-label="Linkedin logo">
      ...
      <div className="w-full max-w-[352px] rounded-lg mx-auto shadow-lg bg-white p-6">
        <div id="organic-div">
          <div className="text-center mb-4">
            ...
            <p className="text-sm font-normal text-gray-600">Stay updated on your professional world.</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className='space-y-1'>
          ...
          <div className="relative mb-10">
            ...
            <input type="email" id="email" name="email" className="bg-gray-100 border mb-6 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="user@email.com" required/>
          </div>

          <label htmlFor="password" className="block mb-1 text-sm font-medium text-gray-800">Your Password</label>
          <div className="relative mb-0">
            ...
            <input type="password" id="password" name="password" className="bg-gray-100 border mb-6 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="Password" required/>
          </div>
          <button type='submit' className="text-white bg-blue-600 font-medium text-sm rounded-full py-3 w-full hover:bg-blue-700">
            Sign In
          </button>
        </form>
      </div>
      ...
      <div className="mt-6 text-center">
        New to LinkinPurry?
        <a href="/register" className="text-blue-600 font-semibold hover:underline">Join now</a>
      </div>
    </main>
  )
}