                  ...
                  userList.map((item, index) => (
                    ...
                    >
                      ...
                      <div className="flex flex-1 justify-between flex-col sm:flex-row">
                        ...
                        <a href='/message' className='border border-blue-700 border-solid mobile:px-[10px] mobile:py-[4px] px-[10px] py-[4px] text-[12px] rounded-[15px] text-blue-700 mobile:text-[14px] sm:ml-[5px] ml-[0px] mr-[5px] hover:text-white hover:bg-blue-700'>Message</a>
                        <button onClick={() => {deleteConnectionRequest(item.user.id); window.location.reload()}} className='border border-red-700 border-solid mobile:px-[10px] mobile:py-[4px] px-[10px] py-[4px] text-[12px] rounded-[15px] text-red-700 mobile:text-[14px] sm:ml-[5px] ml-[0px] mr-[5px] hover:text-white hover:bg-red-700'>Unconnect</button>
                        </div>
                      </div>
                    </li>
                  ))}
