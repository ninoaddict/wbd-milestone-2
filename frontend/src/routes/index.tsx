    ...
    return (
      <div className="flex py-[100px] justify-center">
        <div className="ml-[50px] mr-[50px] xl:mr-[0px] mt-[140px] xl2:mt-[0px] justify-center items-center flex flex-col">
          <p className="text-xl sm:text-3xl lg:text-5xl font-normal flex justify-center text-center items-center">Welcome to your professional community</p>
          <a href="/login" className="text-xs sm:text-sm lg:text-md bg-blue-600 py-1 md:py-1 px-10 sm:px-20 md:px-40 rounded-3xl text-white items-center flex mt-[20px] border border-solid border-blue-600 hover:text-blue-600 hover:bg-white">Sign in with Email</a>
        ...
        <div className="flex justify-end">
          <img src="/guy_working.svg" className="w-[100%] h-[100%] hidden xl2:block"></img>
        </div>
      </div>
    )
  }
